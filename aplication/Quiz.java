...
public class Quiz implements ActionListener {
    ...
    String [] questions =    {
        ...
        String [][] options =     {
                                    {"Zlatan Ibrahimovic", "Cristiano Ronaldo", "Mauro Icardi", "W.Rooney"},
                                    {"2014", "2010", "2022", "2004"},
                                    {"Leo Messi", "Gabriel Junior", "Jesus Cristo", "Batman"},
    ...
    public Quiz(){
        ...
        buttonA.setBackground(new Color(2, 25, 255));
        ...
        buttonB.setBackground(new Color(2, 25, 255));
        ...
        buttonC.setBackground(new Color(2, 25, 255));
        ...
        buttonD.setBackground(new Color(2, 25, 255));
        buttonD.setFont(new Font("MV Boli", Font.BOLD, 25));
        buttonD.setFocusable(false);
        buttonD.addActionListener(this);
        buttonD.setText("D");

        answer_labelA.setBounds(122, 100, 500, 100);
        answer_labelA.setBackground(new Color(50,50, 50));
        answer_labelA.setForeground(new Color(25, 255, 0));
        answer_labelA.setFont(new Font("MV Boli", Font.PLAIN, 35));

        answer_labelB.setBounds(122, 200, 500, 100);
        answer_labelB.setBackground(new Color(50,50, 50));
        answer_labelB.setForeground(new Color(25, 255, 0));
        answer_labelB.setFont(new Font("MV Boli", Font.PLAIN, 35));

        answer_labelC.setBounds(122, 300, 500, 100);
        answer_labelC.setBackground(new Color(50,50, 50));
        answer_labelC.setForeground(new Color(25, 255, 0));
        answer_labelC.setFont(new Font("MV Boli", Font.PLAIN, 35));

        answer_labelD.setBounds(122, 400, 500, 100);
